 ...
 */
    /**
     * This file used for validating all the input fields in
     * addProject page. after user hit the submit button it checks
     * all the required fields and respond back with error if
     * there is required field left blank.
     */
